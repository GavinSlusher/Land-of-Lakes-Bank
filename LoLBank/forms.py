...
from wtforms import (StringField, IntegerField, BooleanField, DateField, RadioField, SelectField,
                    TextField, TextAreaField, SubmitField)
from wtforms.fields.html5 import EmailField
from wtforms.validators import DataRequired

# class InfoForm(FlaskForm):
#     breed = StringField('What breed of puppy', validators=[DataRequired()])
#     neutered = BooleanField("Has the puppy been neutered?")
#     mood = RadioField('Please choose it\'s mood:',
...
class AdvisorForm(FlaskForm):
    ...
    expertise = SelectField("Area of Expertise: ", choices=[('tax', 'Taxation'), 
...
class TablesForm(FlaskForm):
    tables = SelectField("Select Table: ", choices=[('clients', 'Clients'), 
                                                    ('accounts', 'Accounts'), 
